...
% \titlecontents{section}[0.8cm]{\bfseries}{\contentslabel{1.5em}}{\hspace*{-1.5em}}{\titlerule*[0.5pc]{$\cdot$}\contentspage}
% \titlecontents{subsection}[1.5cm]{}{\contentslabel{2.5em}}{}{\titlerule*[0.5pc]{$\cdot$}\contentspage}
% \titlecontents{subsubsection}[1.7cm]{}{\contentslabel{3em}}{}{\titlerule*[0.5pc]{$\cdot$}\contentspage}
% 设置contents格式
...
\lstset{
	...
	alsolanguage = matlab,
    alsolanguage = Python,
	basicstyle = \footnotesize \setmainfont{JetBrains Mono}, %设置字体族
